...
left_square = visual.Rect(win,lineColor="black",fillColor="green",size=[100,100],pos = (-100,0))
right_square = visual.Rect(win,lineColor="black",fillColor="pink",size=[100,100],pos = (100,0))

# color_trials = ["blue", "red"]*3
